phew , i had my backup code that has mistakes but was working and showing components !! 

soo listen this code has very minor tweaks , item no 40 whole supplied by (component table) table is missing ! ,and tot. weight problem !! which has mixed value from weight column and ext. weight column !
...
class PDFOCRExtractor:
    ...
    def parse_component_line_enhanced(self, line):
        ...
        if weight_matches:
            ...
            component["Tot. Weight"] = weight_matches[-1][1]
